...
const SIDEBAR_WIDTH_MOBILE = 'full'
      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ? 'p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.6)+0.1rem)]'
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="default"
      size="icon"
      className={`${className} ml-5 mt-5 rounded-full hover:bg-primary hover:text-white md:h-12 md:w-12`}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        'flex h-screen flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        'relative flex h-full w-full min-w-0 flex-col p-2',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn('flex h-full w-full items-center text-sm', className)}
    {...props}
  />
))
